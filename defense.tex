...
\includegraphics[height=55pt]{cefrc-logo}\includegraphics[height=50pt]{logo}
...
\begin{center}
    ...
    \href{https://creativecommons.org/licenses/by/4.0/}{\includegraphics[height=0.25in]{by}}
\end{center}
\vspace{\fill}
\end{frame}
